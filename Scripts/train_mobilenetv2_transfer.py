...
and/Users/aryanthodupunuri/extreme-weather-classification-1/.venv/bin/python SCRIPTS/train_mobilenetv2_transfer.py \
...
Usage examples:
  ...
  python SCRIPTS/train_mobilenetv2_transfer.py \
  ...
  python SCRIPTS/train_mobilenetv2_transfer.py --split-root dataset_split --gradcam --gradcam-samples 12

  # Dry-run to sanity-check a forward/backward step
  python SCRIPTS/train_mobilenetv2_transfer.py --dry-run --limit-per-class 8 --num-workers 0
"""
...
def main():
    ...
    gradcam_dir = report_dir/"gradcam"; ensure_dir(gradcam_dir)
